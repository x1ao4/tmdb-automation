...
- Episode information properly prepared.

### Configuration
Before using Auto Add Episodes, please configure the `/auto-add-episodes/config.ini` file according to the following tips (example).
```
[TMDB]
# Your TMDB username
USERNAME = YOUR_TMDB_USERNAME
...
EPISODES_URL = https://www.themoviedb.org/tv/42009-black-mirror/season/1/edit?active_nav_item=episodes
# Language code of the episode info, e.g., zh-CN for Chinese, en-US for English
LANGUAGE_CODE = en-US
```
...
2. Open the `/auto-add-episodes/config.ini` file in the directory with a text editor, fill in your TMDB username, password, and show details.
3. Save your episode info to `/auto-add-episodes/episodes.txt`.
